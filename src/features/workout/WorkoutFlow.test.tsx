...
describe("WorkoutFlow", () => {
  ...
  it("inicia na condição somente quando recebe uma trilha", () => { setup("push"); expect(screen.getByText("Como você chega para este treino?")).toBeVisible(); arrive(); expect(screen.getByRole("row", { name: /Empurrar 5 min/ })).toBeVisible(); });
